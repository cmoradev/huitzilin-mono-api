...
export class Migration1750718469946 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "school"."debts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "version" integer NOT NULL DEFAULT '0', "description" character varying NOT NULL, "unitPrice" numeric(10,2) NOT NULL, "quantity" numeric(10,2) NOT NULL, "amount" numeric(10,2) NOT NULL, "discount" numeric(10,2) NOT NULL, "subtotal" numeric(10,2) NOT NULL, "taxes" numeric(10,2) NOT NULL, "total" numeric(10,2) NOT NULL, "withTax" boolean NOT NULL DEFAULT true, "state" "school"."debts_state_enum" NOT NULL, "frequency" "school"."debts_frequency_enum" NOT NULL, "dueDate" date NOT NULL, "paymentDate" TIMESTAMP, "enrollmentId" uuid NOT NULL, CONSTRAINT "PK_4bd9f54aab9e59628a3a2657fa1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
