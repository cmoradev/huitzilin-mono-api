...
export class Migration1752179861631 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "school"."debts" RENAME COLUMN "pendingPayment" TO "branchId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "finance"."concepts" ADD "pendingPayment" numeric(10,2) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "school"."debts" DROP COLUMN "branchId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "school"."debts" ADD "branchId" uuid NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "school"."debts" ADD "branchId" numeric(10,2) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "finance"."concepts" DROP COLUMN "pendingPayment"`,
    );
    await queryRunner.query(
      `ALTER TABLE "school"."debts" RENAME COLUMN "branchId" TO "pendingPayment"`,
    );
  }
}
