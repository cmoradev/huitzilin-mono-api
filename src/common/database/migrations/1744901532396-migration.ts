...
export class Migration1744901532396 implements MigrationInterface {
  name = 'Migration1744901532396';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "school"."activities" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "version" integer NOT NULL DEFAULT '0', "name" character varying(32) NOT NULL, "order" integer NOT NULL, "quantity" integer NOT NULL, "isPackage" boolean NOT NULL DEFAULT false, "inPackage" boolean NOT NULL DEFAULT false, "branchId" uuid NOT NULL, CONSTRAINT "PK_7f4004429f731ffb9c88eb486a8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "school"."enrollments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "version" integer NOT NULL DEFAULT '0', "details" character varying(128) NOT NULL, "state" "school"."enrollments_state_enum" NOT NULL, "order" integer NOT NULL, "isPackage" boolean NOT NULL DEFAULT false, "inPackage" boolean NOT NULL DEFAULT false, "branchId" uuid NOT NULL, "studentId" uuid NOT NULL, "activityId" uuid NOT NULL, "cycleId" uuid NOT NULL, "classroomId" uuid NOT NULL, "parentId" uuid, CONSTRAINT "PK_7c0f752f9fb68bf6ed7367ab00f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "school"."enrollments" ADD CONSTRAINT "FK_f37157c3f17ccb242e8268cc97a" FOREIGN KEY ("parentId") REFERENCES "school"."enrollments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "school"."enrollments" DROP CONSTRAINT "FK_f37157c3f17ccb242e8268cc97a"`,
    );
    await queryRunner.query(
